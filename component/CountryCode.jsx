...
export const CountryCode = () => {
  return (
    <>
      ...
      <option data-countrycode="GB" name="countrycode" value="+44">
        UK (+44)
      </option>
      <optgroup label="Other countries">
        ...
        <option data-countrycode="BV" value="+47">
          Bouvet Island (+47)
        </option>
        ...
        <option data-countrycode="TF" value="+">
        ...
        <option data-countrycode="HM" value="+011">
        ...
        <option data-countrycode="UM" value="+246">
        ...
        <option data-countrycode="AX" value="+358">
          Aaland Islands (+358)
        </option>
